...
def written_as_a_function_to_save_memory(z_bins):
    ...
    #planckmask=fits.open('COM_CMB_IQU-smica_2048_R3.00_full.fits')

    #planckImask=planckmask[1].data['TMASK']

    #coord=SkyCoord(catalog[0],catalog[1],frame='icrs',unit='deg').galactic
    #l,b=coord.l.deg,coord.b.deg
    #catalog=catalog[:,planckImask[healpy.ang2pix(2048,l,b,nest=True,lonlat=True)]==1]
...
for z_bins in range(4):
    written_as_a_function_to_save_memory(z_bins)
