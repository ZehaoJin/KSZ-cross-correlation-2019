...
np.save('datalog/SuperCosmos_z_0.npy',np.mean(result[0],axis=0))
np.save('datalog/SuperCosmos_z_1.npy',np.mean(result[1],axis=0))
np.save('datalog/SuperCosmos_z_2.npy',np.mean(result[2],axis=0))
np.save('datalog/SuperCosmos_z_3.npy',np.mean(result[3],axis=0))
